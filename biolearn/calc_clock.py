...
def calc_alcohol_mccartney(DNAm, pheno=None):
    ...
    if CpGCheck:
        ...
        tt = betas.multiply(Alcohol_CpGs.loc[present, 'CoefficientTraining'].values, axis=1).sum(axis=1)
...
def calc_bmi_mccartney(DNAm, pheno=None):
    ...
    if CpGCheck:
        ...
        tt = betas.multiply(BMI_CpGs.loc[present, 'CoefficientTraining'].values, axis=1).sum(axis=1)
...
def calc_bohlin(DNAm, pheno=None):
    ...
    if CpGCheck:
        ...
        tt = betas.multiply(Bohlin_CpGs.loc[present, 'Coefficient'].values, axis=1).sum(axis=1) + 277.2421
...
def calc_DNAmClockCortical(DNAm, pheno=None, CpGImputation=None, imputation=False):
    ...
    if CpGCheck:
        ...
        tt = betas.multiply(DNAmClockCortical_CpGs.loc[present, 'Coefficient'].values, axis=1).sum(axis=1) + 0.577682570446177
...
def calc_DNAmTL(DNAm, pheno=None, CpGImputation=None, imputation=False):
    ...
    if CpGCheck:
        ...
        tt = betas.multiply(DNAmTL_CpGs.loc[present, 'Coef'].values, axis=1).sum(axis=1) - 7.924780053
...
def calc_Hannum(DNAm, pheno=None, CpGImputation=None, imputation=False):
    ...
    if CpGCheck:
        ...
        tt = betas.multiply(Hannum_CpGs.loc[present, 'Coefficient'].values, axis=1).sum(axis=1)
...
def calc_Horvath1(DNAm, pheno=None, CpGImputation=None, imputation=False):
    ...
    if CpGCheck:
        ...
        tt = betas.multiply(Horvath1_CpGs.loc[present, 'CoefficientTraining'].values, axis=1).sum(axis=1)
...
def calc_Horvath2(DNAm, pheno=None, CpGImputation=None, imputation=False):
    ...
    if CpGCheck:
        ...
        tt = betas.multiply(Horvath2_CpGs.loc[present, 'CoefficientTraining'].values, axis=1).sum(axis=1)
...
def calc_HRSInChPhenoAge(DNAm, pheno=None, CpGImputation=None, imputation=False):
    ...
    if CpGCheck:
        ...
        tt = betas.multiply(HRSInCHPhenoAge_CpGs.loc[present, 'CoefficientTraining'].values, axis=1).sum(axis=1) + 52.8334080
...
def calc_Knight(DNAm, pheno=None, CpGImputation=None, imputation=False):
    ...
    if CpGCheck:
        ...
        tt = betas.multiply(Knight_CpGs.loc[present, 'CoefficientTraining'].values, axis=1).sum(axis=1) + 41.7
